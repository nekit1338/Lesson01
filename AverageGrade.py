...
for i in grades:  # Проходимся циклом "for in" по списку grades 
    average = sum(i)/len(i)  # sum(i) - сумма элементов вложенных списков внутри grades; len(i) - длина i-го списка
